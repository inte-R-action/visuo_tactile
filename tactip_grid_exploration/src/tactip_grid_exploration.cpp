...
//    visual_tools.prompt("Press 'next' in the RvizVisualToolsGui window to continue with the next action");
    ...
    // touch on the PCB
/*    targetJoints["shoulder_pan_joint"] = -0.0;
    targetJoints["shoulder_lift_joint"] = -0.449;
    targetJoints["elbow_joint"] = 0.398;
    targetJoints["wrist_1_joint"] = -1.536;
    targetJoints["wrist_2_joint"] = -1.560;
    targetJoints["wrist_3_joint"] = 0.010;
*/

/*
    targetJoints["shoulder_pan_joint"] = -0.0;
    targetJoints["shoulder_lift_joint"] = -0.45;
    targetJoints["elbow_joint"] = 0.40;
...
//    float xPosition [3] = { 0.0, 0.0, -0.01};
//    float yPosition [3] = { 0.0, 0.0,   0.0};
//    float zPosition [3] = {-0.1, 0.1,   0.0};

//    float yHomePosition [5] = {0.0, -0.01, -0.02, -0.03, -0.04};


    // touch on the silicon

//    float xPosition [3] = { 0.0, 0.0, -0.005};
    float xPosition [3] = { 0.0, 0.0, -0.001};
    float yPosition [3] = { 0.0, 0.0,   0.0};
    float zPosition [3] = {-0.003, 0.003,   0.0};
...
//    float xPosition [3] = { 0.0, 0.0, -0.005};
    float xPosition [3] = { 0.0, 0.0, -0.001};
    float yPosition [3] = { 0.0, 0.0,   0.0};
    float zPosition [3] = {-0.109, 0.109,   0.0};
*/
//    float yHomePosition [5] = {0.0, -0.005, -0.01, -0.015, -0.02};
    float yHomePosition [14] = {0.0, -0.001, -0.002, -0.003, -0.004, -0.005, -0.006, -0.007, -0.008, -0.009, -0.010, -0.011, -0.012, -0.013};
